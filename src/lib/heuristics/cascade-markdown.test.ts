...
describe("runCascadeFromMarkdown — real-world DOCX fixtures", () => {
  ...
  const TURNDOWN_ESCAPED_EMAIL_DOCX = [
    ...
    "",
    "Cupertino, CA | Annam\\_Srinivas@hotmail.com | 408-996-2758",
    "",
    "**SUMMARY**",
    "",
    ...
    "**EXPERIENCE**",
    "",
    "**Sr. Software Engineer** · DESHWEB.COM _Dec '00 - Present_",
    "",
    "• Did the initial research, development as well as guiding other team members for the development of this windows keyboard emulator application.",
    "",
    "• Created Keymap Creator application using C#, Visual Studio .NET and Microsoft Access.",
    "",
    "**Sr. Consultant** · SIEMENS ICN _Apr 1995 - Dec 2000_",
    "",
    "• Designed XML interface for doing database / LDAP operations.",
    "",
    "• Implemented the XML output mechanism using Visual C++, ATL, STL.",
    "",
    "**Sr. Software Engineer** · E-Z DATA, INC. _May '94 - April '95_",
    "",
    "• Enhanced different modules of the contact management software.",
    "",
    "**Sr. Software Engineer** · BMD, INC. _Oct '92 - May '94_",
    "",
    "• While leading a team, reengineered a MacApp based Apple product into an OS/2 based application.",
    "",
    "**Software Engineer** · HCL LIMITED _June '89 - Aug '90_",
    "",
    "• Enhanced HCL COBOL 5.0's Accept/Display statements for new syntax.",
    "",
    "**EDUCATION**",
    "",
    "Jawaharlal Nehru Technological University — Bachelor of Technology - Computer Science and Engineering — 1989",
    "",
    "**SKILLS**",
    "",
  ...
  it("the previously-0.76 DOCX now clears CANONICAL_CONFIDENCE_THRESHOLD", async () => {
    ...
    expect(result.parsed.email).toBe("Annam_Srinivas@hotmail.com");
    expect(result.parsed.experience.length).toBeGreaterThanOrEqual(2);
  ...
  const SPLIT_LETTER_HEADER_DOCX = [
    ...
    "",
    "### Alphabet / Google Fiber - Customer Experience Engineering",
    "",
    "![](data:image/png;base64,iVBORw0KGgo" + "A".repeat(1000) + ") 04/2021 - Present ![](data:image/png;base64,BBBBB) Mountain View, CA",
    "",
    "- Built a 50-member team across three global sites.",
    "- Enhanced Android Play Store rating from 1.9 to 3.8.",
    "- Launch of a new cross-functional widgetized architecture with ~10% CSAT improvement.",
    "",
    "## Sr. Engineering Manager (L6 / L7)",
    "",
    "### Google Assistant, Assistant on Android TV",
    "",
    "![](data:image/png;base64,CCC) 06/2017 - 04/2021 ![](data:image/png;base64,DDD) Mountain View, CA",
    "",
    "- Managed a successful team for Assistant on Android TV.",
    "- Improved yield by 44%.",
    "",
    "## IC, Technical Lead",
    "",
    "### Google Cloud Networking, Google Play Books, Accessibility",
    "",
    "![](data:image/png;base64,EEE) 11/2006 - 04/2017 ![](data:image/png;base64,FFF) Mountain View, CA",
    "",
    "- Managed a team of 5 on Control Plane for Hybrid Cloud APIs.",
    "- Improved Gmail's accessibility by adding screen-reader compatibility.",
    "",
    "# E DUCATION",
    "",
    ...
    "",
    "![](data:image/png;base64,GGG) 1985 - 1989 e Hyderabad, India",
  ].join("\n");
...
describe("runCascadeFromMarkdown — two-column DOCX with sidebar bleedthrough", () => {
  ...
  //
  // Additionally: Sri's entries use `## Title` + `### Company` (modern
  ...
  const TWO_COLUMN_SIDEBAR_DOCX = [
    ...
    "",
    "04/2021 - Present Mountain View, CA",
    "",
    "- Built a 50-member team across three global sites.",
    "- Enhanced Android Play Store rating from 1.9 to 3.8.",
    "",
    ...
    "",
    "06/2017 - 04/2021 Mountain View, CA",
    "",
    "- Managed a significantly successful team for Assistant on Android TV.",
    "- Improved yield by 44%.",
    "",
    ...
    "",
    "11/2006 - 04/2017 Mountain View, CA",
    "",
    ...
    "Over 200+ interviews.",
    "",
    "07/2004 - 11/2006 Mountain View, CA",
    "",
    "- Architected accessibility support for the Boxely UI framework.",
    "",
    "## Vendor Consultant",
    "",
    "### Microsoft",
    "",
    "06/2003 - 03/2004 Redmond, WA",
    "",
    "- Built new soft keyboard for Tablet PC and Windows.",
    "",
    "## Self Employed",
    "",
    "### Deshweb.com / Aksharamala",
    "",
    "12/2000 - 05/2003 Cupertino, CA",
    "",
    "- Built a Windows keyboard using transliteration using Keyboard Hooks.",
    "",
    "# E DUCATION",
    "",
    "## Bachelor of Technology in Computer Science & Engineering",
  ...
  it("assigns title/company correctly when H2=title, H3=company (modern convention)", async () => {
    ...
    expect(first.company).toMatch(/Alphabet.*Google Fiber/);
